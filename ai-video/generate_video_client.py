...
def main():
    ...
    # Configuration - can use environment variables or set directly
    ENDPOINT_ID = os.getenv("RUNPOD_ENDPOINT_ID", "mesulo-endpoint-id")
    RUNPOD_API_KEY = os.getenv("RUNPOD_API_KEY", "mesulo-runpod-api-key")
    
    if ENDPOINT_ID == "mesulo-endpoint-id" or RUNPOD_API_KEY == "mesulo-runpod-api-key":
        print("⚠️  Warning: Using placeholder values. Please set RUNPOD_ENDPOINT_ID and RUNPOD_API_KEY environment variables")
        print("   or update the values in this script.")
        print("   Example: export RUNPOD_ENDPOINT_ID='your-endpoint-id'")
