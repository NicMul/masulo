...
*   classNames: classes passed to the daypicker (SCSS or tailwind style, optional)
*   showOutsideDays: show days outside current month (boolean, optional)
*
**********/
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: 'h-9 w-9 text-center p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-slate-100/50 [&:has([aria-selected])]:bg-slate-100 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 dark:[&:has([aria-selected].day-outside)]:bg-slate-800/50 dark:[&:has([aria-selected])]:bg-slate-800',
        ...
        day_outside: 'text-slate-500 opacity-50 aria-selected:bg-slate-100/50 aria-selected:text-slate-500 aria-selected:opacity-30 dark:text-slate-400 dark:aria-selected:bg-slate-800/50 dark:aria-selected:text-slate-400',
      ...
      components={{
        IconLeft: ({ ...props }) => <Icon name='chevron-left' />,
        IconRight: ({ ...props }) => <Icon name='chevron-right' />,
      }}
      {...props} />
  );
}
