...
*
*   PROPS
*   items: [{ name: string, url: string }] (array, required)
*
**********/
...
const Breadcrumb = forwardRef(({ items, ...props }, ref) => (
...
const BreadcrumbList = forwardRef(({ className, ...props }, ref) => (
  ...
  <ol ref={ ref } className={ cn('flex flex-wrap items-center gap-1.5 break-words text-slate-500 sm:gap-2.5 dark:text-slate-400', className) } {...props } />
))
